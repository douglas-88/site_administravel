...
<form action="" method="POST" id="form_user_create" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <div class="form-group">
            <label for="userPassword"><h4><strong class="text-danger">*</strong>Senha:</h4></label>
            <input name="password" id="userPassword" type="text" class="form-control">
            <small id="passwordHelp" class="form-text text-muted">Mínimo de 6 a 12 caracteres.</small>
        </div>
    </div>
    <div class="form-group clearfix">
        ...
        <img width="200" class="rounded float-right rounded" id="avatar_preview">
    </div>
